...
def chart_demo():
    ...
    return render_template('chart_demo.html', values=demo.df['value'], labels=demo.df['label'], type='pie')
...
def chart_static_demo():
    ...
    return render_template('chart_static.html', values=values, labels=labels, set=zip(values, labels, colors))
